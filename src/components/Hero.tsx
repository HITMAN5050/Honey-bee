...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-brand-cream">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-brand-white/75 via-brand-white/55 to-brand-cream/90 backdrop-blur-[2px] z-10" />

      {/* Subtle honey glow trims */}
      <div className="absolute -bottom-48 -left-48 w-96 h-96 bg-brand-honey/10 rounded-full blur-3xl pointer-events-none z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-brand-honey/20 bg-brand-white/50 backdrop-blur-md text-brand-honey text-xs font-semibold tracking-wider uppercase mb-8 shadow-sm">
          ...
          >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 rounded-full border border-brand-honey/40 text-brand-honey bg-brand-white/40 backdrop-blur-md font-semibold tracking-wide hover:bg-brand-honey hover:text-brand-white transition-all duration-300 hover:-translate-y-0.5"
            >
